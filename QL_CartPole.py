...
Episode_reward = []
class CartPole():
    def __init__(self, buckets=(1, 1, 6, 12,), max_env_steps=None, monitor=False):
        self.buckets = buckets # down-scaling feature space to discrete range
        self.n_episodes = 500 # training episodes
    ...
    def run(self):
        for e in range(self.n_episodes):
            ...
            print('Episode: {} | Episode reward: {} '.format(e+1, reward_sum))
...
if __name__ == "__main__":
    ...
    plt.title('Episode_reward(Q-learning)')
    plt.xlabel('Episode')
    plt.show()